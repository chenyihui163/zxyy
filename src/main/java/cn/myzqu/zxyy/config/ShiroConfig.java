...
import cn.myzqu.zxyy.shiro.KickoutSessionControlFilter;
import cn.myzqu.zxyy.shiro.RedisShiroSessionDao;
...
public class ShiroConfig {
	...
	@Bean("sessionManager")
	public SessionManager sessionManager(RedisShiroSessionDao redisShiroSessionDao, @Value("${zxyy.redis.open}") boolean redisOpen,@Value("${zxyy.shiro.redis}") boolean shiroRedis )
	{
